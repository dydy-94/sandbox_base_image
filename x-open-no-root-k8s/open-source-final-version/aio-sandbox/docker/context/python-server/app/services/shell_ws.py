...
class TerminalWsManager:
    ...
    def _build_session_env(
        ...
        # Hard-code TERM so bash/NLE prompts and terminfo (clear, etc.)
        # work regardless of what the parent process inherited.
        merged_env.setdefault("TERM", "xterm-256color")
        for key in ("HOME", "USER", "COLORTERM"):
    ...
    async def create_session(
        ...
        try:
            ...
            session.send_input('export TERM=xterm-256color\n')
