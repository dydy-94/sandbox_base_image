        ...
        production_config.update(
            {
                ...
                # uvloop is optional; on CN mirrors its C-extension *.so is
                # often truncated which crashes the venv with SIGSEGV at
                # import time. Falling through to the asyncio loop is slower
                # but reliable.
                'loop': 'asyncio',
